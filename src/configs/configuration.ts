...
export default (): Config => ({
  ...
  // Призначення: Використовується для зберігання великих файлів (об'єктів) — від документів до мультимедійних даних.
  // Особливості: Сумісність із S3 API, висока масштабованість для зберігання даних у клауд-середовищах.
