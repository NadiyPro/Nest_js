...
export class TagEntity extends CreateUpdateModel {
  ...
  // Ця колонка використовується для
  // відображення обчисленого значення кількості статей, пов'язаних з тегом.
  articleCount?: number;
  // Визначає віртуальну колонку articleCount, яка не зберігається фізично в базі даних
}
// @OneToOne(() =>):
