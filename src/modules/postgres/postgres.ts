    ...
    TypeOrmModule.forRootAsync({
      useFactory: (configService: ConfigService<Config>) => {
        ...
        return {
          ...
          // Ентіті - це типу як моделі, що ми описували (юзери, авто і т.п),
          // кожна модель - це окрема таблиця буде, ми для юзера такий опис зробили в database/entities/user.entity.ts
