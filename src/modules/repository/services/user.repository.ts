...
// цей клас надає спеціалізований репозиторій для UserEntity,
// який можна використовувати для зберігання та
// отримання користувацьких даних у БД
// з можливістю додати кастомну логіку, яка відноситься до UserEntity
